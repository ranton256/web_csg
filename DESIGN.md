...
- After every Boolean operation: intervals of length ≤ `ε` are dropped
  ...
  a side line, within `ε`, has real length and is a hit, per D20); in a union, intervals whose gap
