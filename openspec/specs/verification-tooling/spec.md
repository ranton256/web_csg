# verification-tooling Specification
...
Source: DESIGN §7 (scripted test support) and §9, CONSTRAINTS §4–§5 (commands, definition of done); established by change `m0-foundations` (M0).
