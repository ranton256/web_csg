# stale-preview Specification

## Purpose

Never loses the picture: when the source stops being valid, the preview keeps
showing the last valid model and says clearly that it is stale.
