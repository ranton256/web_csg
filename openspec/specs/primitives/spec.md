...
Defines the solid primitives (`sphere`, `cube`, `box`, and `cylinder`), their
parameters, size rules, and extents in local coordinates. The sphere arrived
in M1; cube, box, and cylinder in M3.
